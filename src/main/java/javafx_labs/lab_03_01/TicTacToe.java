...
public class TicTacToe extends Application {
    ...
    public void start(Stage primaryStage) throws IOException {
        ...
        // Randomly set blank spaces, Xs, and Os in the 3x3 grid (image links can be
                ...
                switch ((int) (Math.random() * 3)) {
                    case 0: // Fill space with an X.
                        imageViews[i][j] = new ImageView(
                                new Image("https://media.tenor.com/OdB60pI5DO4AAAAM/letter-x.gif"));
                        break;
                    case 1: // Fill space with an O.
                        imageViews[i][j] = new ImageView(
                                new Image("https://media.tenor.com/doRV9tAq3U0AAAAM/dancing-letter.gif"));
                        break;
        ...
        // Since the board is 3x3, the width and height of each square should take up
        // 1/3 of the board.
        ...
        primaryStage.setResizable(false); // Make sure the window is not resizable to prevent distortions to the board's
                                          // shape.
        primaryStage.show();
    }
