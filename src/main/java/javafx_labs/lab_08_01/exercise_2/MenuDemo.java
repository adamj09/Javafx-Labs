package javafx_labs.lab_08_01.exercise_2;
...
public class MenuDemo extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // Open context menu on secondary click on hBox1
        hBox1.setOnMouseClicked(e -> {
            if (e.getButton() == MouseButton.SECONDARY) {
                contextMenu.show(hBox1, e.getScreenX(), e.getScreenY());
            }
        });

        // Hide context menu when using primary mouse button anywhere on scene.
