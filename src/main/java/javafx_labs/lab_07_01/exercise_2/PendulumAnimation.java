package javafx_labs.lab_07_01.exercise_2;
...
public class PendulumAnimation extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // Pause and play opacity change.
        scene.setOnKeyPressed(e -> {
            if(e.getCode() == KeyCode.SPACE && fadeTransition.getStatus() == Status.RUNNING) {
                fadeTransition.pause();
            } else if(e.getCode() == KeyCode.ESCAPE && fadeTransition.getStatus() == Status.PAUSED) {
                fadeTransition.play();
            }
        });
